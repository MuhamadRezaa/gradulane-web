...
@section('main')
    <div class="card m-1 p-4">
        ...
        <form method="post" action="/admin/bimbingan/editpembahasanp1/{{ $bimbingan->id }}">
            @csrf
            ...
            <div class="width-75">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="pembimbing2_id" name="pembimbing_id"
                        value="{{ $tugasakhir->pembimbingta1->namadosen }}" readonly>
                    <input type="hidden" name="pembimbing_id" value="{{ $tugasakhir->pembimbingta1->id }}">
                    @error('pembimbing_id')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
