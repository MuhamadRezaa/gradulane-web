...
@section('main')
    <div class="card m-1 p-4">
        ...
        <form method="post" action="/admin/bimbingan/tambahpembahasanp2">
            @csrf
            <div class="width-75">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="pembimbing_id" name="pembimbing_id"
                        value="{{ $bimbingan->pembimbingta2->namadosen }}" readonly>
                    <input type="hidden" name="pembimbing_id" value="{{ $bimbingan->pembimbingta2->id }}">
                    @error('pembimbing_id')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
