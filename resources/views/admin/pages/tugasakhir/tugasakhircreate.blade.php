        ...
        <form method="post" action="/admin/tugasakhir" enctype="multipart/form-data">
            ...
            <div class="width-75">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="judul1" name="judul1" value="{{ old('judul1') }}">
                    @error('judul1')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="judul2" name="judul2" value="{{ old('judul2') }}">
                    @error('judul2')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="cttmhs" rows="3" name="cttmhs">{{ old('cttmhs') }}</textarea>
                    @error('cttmhs')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
